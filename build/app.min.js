...
},{"./canvas/CanvasController":6,"./data/DataController":9,"./global/Events":12,"./global/util":14,"./plugins":23,"./workspace/WorkspaceController":24}],6:[function(require,module,exports){
...
=======
},{"../global/util.js":9,"react":"react"}],11:[function(require,module,exports){
>>>>>>> Stashed changes
'use strict';
...
module.exports = function(exposedData) {
    ...
    var TranslateLink = React.createClass({displayName: "TranslateLink",
        ...
        render: function() {
            return React.createElement("span", {onClick: this.translate, "data-direction": "{this.props.direction}", className: "tool"}, this.props.glyph)
        }
    });
...
},{"./FourPointWeightTransform.jsx":16,"./GridManager.jsx":17,"./InspectPoint.jsx":18,"./LayerManager.jsx":19,"./PointRandomise.jsx":20,"./PointTranslate.jsx":21,"./Shapes.jsx":22}],24:[function(require,module,exports){
...
},{"./../panels/PanelController.jsx":15,"./actionbar/ActionBarController.jsx":25}],25:[function(require,module,exports){
var util = require('../../global/util.js');
