...
let RuneNodeFactory = require('./RuneNodeFactory');
    ...
    function RuneArcView(point, renderedPoint) {

        let center = new paper.Point(point.arcIn.center.map(function(v)  {return +v;}));
...
/* ========== Tablet ========== */
    ...
    Object.defineProperty(RuneView.prototype,"generatePath",{writable:true,configurable:true,value:function(path, style, isPreview) {
        ...
        if (paths.length > 1) {
            return paths.reduce(function(p, c)  {return c.join(p);});
        } else if (paths[0]) {
            return paths[0];
        } else {
            return null;
        ...
        return (
            React.createElement("div", {
                ...
                React.createElement("small", null, 
                    React.createElement("span", null, "x: ", x, ", y:", y)
                ), 
...
},{"./const":26}],29:[function(require,module,exports){
/* ========== Utilities ========== */
