...
},{"./features/canvas/CanvasController":7,"./features/workspace/WorkspaceController":12,"./global/Events":14,"./global/Util":15,"./models/DataController":18,"./plugins":24}],7:[function(require,module,exports){
...
var gridPointFactory = function(point, size)  {
...
},{"../../global/Const":13,"../../global/Events":14,"../../global/util":17,"../../models/RunePoint":20,"paper":"paper"}],9:[function(require,module,exports){
var Events = require('../../global/Events');
var paper = require('paper');
...
var Events = require('../../global/Events');
    ...
    Object.defineProperty(PanelController.prototype,"init",{writable:true,configurable:true,value:function( ) {
        ...
        Events.selectPoint.add(function()  {
            ...
            render: function() {
                return (
                    React.createElement("div", null, 
                        ...
                        React.createElement("input", {type: "text", ref: "res", defaultValue:  this.state.data.res}), 
...
},{"../global/Events":14,"react":"react"}],23:[function(require,module,exports){
'use strict';
                        ...
                        React.createElement("ul", null, 
                                ...
                                this.props.data.map(function(point) {
                                    ...
                                    return React.createElement("li", null, 
                                        point.point.x, ", ", point.point.y, React.createElement("br", null), 
...
},{"./GridManager.jsx":22,"./InspectPoint.jsx":23}]},{},[6]);
