...
},{"./features/canvas/CanvasController":11,"./features/workspace/WorkspaceController":21,"./global/Events":23,"./global/Util":25,"./global/keys":27,"./models/DataController":30}],8:[function(require,module,exports){
'use strict';
...
},{"../../global/Const":22,"../../global/Events":23,"../../global/util":29,"../../models/RunePoint":33,"paper":"paper"}],13:[function(require,module,exports){
'use strict';
                ...
                paperPath = new paper.CompoundPath({
                    children: paths.map(function(p)  {
                        return new paper.Path({
                            segments: $RuneView_this.getPathSegment(p, isPreview)
                        });
                    }),
                    style: style
                })
...
/* ========== Rune Model ========== */
    ...
    function RunePathModel(data) {"use strict";
        ...
        this.children.map(function(c)  {return new RunePathModel(c);});
    }
