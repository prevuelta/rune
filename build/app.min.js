...
},{"./features/canvas/CanvasController":11,"./features/workspace/WorkspaceController":16,"./global/Events":18,"./global/Util":19,"./global/keys":21,"./models/DataController":23,"./plugins":31}],8:[function(require,module,exports){
'use strict';
...
},{"../../global/Events":18,"../../global/Util":19,"./GridView.js":12,"./RuneView.js":13,"paper":"paper"}],12:[function(require,module,exports){
var Util = require('../../global/util');
...
},{"../../global/Const":17,"../../global/Events":18,"../../global/util":22,"../../models/RunePoint":26,"paper":"paper"}],13:[function(require,module,exports){
var Events = require('../../global/Events');
var paper = require('paper');
...
},{"../../global/Events":18,"paper":"paper"}],14:[function(require,module,exports){
'use strict';
    ...
    Object.defineProperty(PanelController.prototype,"init",{writable:true,configurable:true,value:function( ) {
                    ...
                    React.createElement("div", null, 
                            ...
                            this.state.panels.map(function(panel, idx) {
                                ...
                                return React.createElement(PanelWrapper, {offset: idx, options: {title : panel.title, collapsed: panel.collapsed}}, 
                                     React.createElement(Component, {data: $PanelController_this.state.data, canvas: $PanelController_this.state.canvas})
                                 );
                            })
        ...
        let panels = React.render(
            React.createElement(Panels, {
                panels: $PanelController_this.app.plugins, 
                data: $PanelController_this.app.data, 
                canvas: $PanelController_this.app.canvas}),
            document.getElementById('rune-panels')
        );

        function reloadHandler () {
            console.log("Reloading panels...");
            panels.replaceState({'data' : $PanelController_this.app.data, 'panels' : $PanelController_this.app.plugins, canvas: $PanelController_this.app.canvas });
        };

        Events.reloadPanels.add(reloadHandler.bind($PanelController_this));

        Events.refreshPanels.add(function()  {
            console.log("Refreshing panels...");
            panels.setState({'data' : $PanelController_this.app.data});
        });
...
},{"../../global/Events":18,"../../global/Util":19,"react":"react","react-draggable":1}],15:[function(require,module,exports){
'use strict';
...
},{"../../components/Button.jsx":8,"../../components/Dialogue.jsx":9,"../../global/Events":18,"paper":"paper","react":"react"}],16:[function(require,module,exports){
...
},{"./../panels/PanelController.jsx":14,"./ActionBarController.jsx":15}],17:[function(require,module,exports){
module.exports = {
...
},{"signals":6}],19:[function(require,module,exports){
/* ========== Utilities ========== */
...
},{"./Events":18}],22:[function(require,module,exports){
/* ========== Utilities ========== */
...
},{"../global/Events":18,"./RuneModel":25,"./TabletModel":27,"lodash":"lodash"}],24:[function(require,module,exports){
...
},{"../global/const":20}],25:[function(require,module,exports){
...
},{"./RunePoint":26}],26:[function(require,module,exports){
/* ========== Point Model ========== */
...
},{"./GridModel":24,"./RuneModel":25}],28:[function(require,module,exports){
'use strict';
...
},{"../components/Button.jsx":8,"../global/Events":18,"react":"react"}],29:[function(require,module,exports){
'use strict';
...
},{"../components/Button.jsx":8,"../components/Switch.jsx":10,"../global/Events":18,"react":"react"}],30:[function(require,module,exports){
'use strict';
...
},{"paper":"paper","react":"react"}],31:[function(require,module,exports){
module.exports = [
...
},{"./GridManager.jsx":28,"./InspectPath.jsx":29,"./LayerManager.jsx":30}]},{},[7]);
