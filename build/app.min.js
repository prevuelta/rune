...
},{"./features/canvas/CanvasController":10,"./features/workspace/WorkspaceController":15,"./global/Events":17,"./global/Util":18,"./global/keys":20,"./models/DataController":22,"./plugins":29}],8:[function(require,module,exports){
'use strict';
...
/* ========== Tablet ========== */
    ...
    Object.defineProperty(RuneView.prototype,"draw",{writable:true,configurable:true,value:function(isPreview) {"use strict";
    ...
    Object.defineProperty(RuneView.prototype,"createRuneSegment",{writable:true,configurable:true,value:function(point, transform, isPreview) {"use strict";
...
var Events = require('../../global/Events');
    ...
    Object.defineProperty(PanelController.prototype,"init",{writable:true,configurable:true,value:function( ) {
                    ...
                    React.createElement("div", null, 
                            ...
                            this.state.panels.map(function(panel, idx) {
                                ...
                                return React.createElement(PanelWrapper, {offset: idx, options: {title : panel.title, collapsed: panel.collapsed}}, 
                                     React.createElement(Component, {data: $PanelController_this.state.data})
                                 );
                            })
        ...
        let panels = React.render(
            React.createElement(Panels, {panels: $PanelController_this.app.plugins, data: $PanelController_this.app.data}),
        ...
        render: function() {
            return (
                React.createElement("div", null, 
                    ...
                    React.createElement(Button, {handler: this.updateData, symbol: "Update"}
                    )
                )
            );
        }
...
},{"../global/Events":17,"react":"react"}],28:[function(require,module,exports){
'use strict';
    ...
    render: function() {
        ...
        return (
            React.createElement("div", {
                ...
                React.createElement(Button, {handler: this.deletePoint, symbol: "X"}), 
        ...
        render: function() {
            return (
                React.createElement("div", {className: "sheet"}, 
                    "Path", 
                    React.createElement(Button, {handler: this.addPath, symbol: "+"}), 
...
},{"./GridManager.jsx":27,"./InspectPath.jsx":28}]},{},[7]);
