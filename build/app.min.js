...
},{"./features/canvas/CanvasController":7,"./features/workspace/WorkspaceController":12,"./global/Events":14,"./global/Util":15,"./models/DataController":18,"./plugins":22}],7:[function(require,module,exports){
...
/* ========== Data ========== */
    ...
    Object.defineProperty(DataController.prototype,"selectPoint",{writable:true,configurable:true,value:function(data) {"use strict";
        debugger;
        if(data[0]) {
            this.tablet.activeRune.selectedPoints.push(data);
            this.tablet.activeRune.currentPointIndex = data;
        } else {
            this.tablet.activeRune.selectedPoints = _.reject(this.tablet.activeRune.selectedPoints, function(val)  {
