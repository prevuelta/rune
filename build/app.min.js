...
},{"./features/canvas/CanvasController":9,"./features/workspace/WorkspaceController":14,"./global/Events":16,"./global/Util":18,"./global/keys":20,"./models/DataController":22,"./plugins":31}],7:[function(require,module,exports){
'use strict';
...
},{"../../global/Events":16,"../../global/Util":18,"./GridView.js":10,"./RuneView.js":11,"paper":"paper"}],10:[function(require,module,exports){
var Util = require('../../global/util');
...
},{"../../global/Const":15,"../../global/Events":16,"../../global/util":21,"../../models/RunePoint":25,"paper":"paper"}],11:[function(require,module,exports){
var Events = require('../../global/Events');
var paper = require('paper');
...
var Events = require('../../global/Events');
    ...
    Object.defineProperty(PanelController.prototype,"init",{writable:true,configurable:true,value:function( ) {
        ...
        let panels = React.render(
            React.createElement(Panels, {panels: $PanelController_this.app.plugins, data: $PanelController_this.app.exposedData}),
        ...
        Events.refreshPanels.add(function()  {
            ...
            panels.setState({'data' : $PanelController_this.app.exposedData});
        });
...
},{"../../global/Events":16,"../../global/Util":18,"react":"react","react-draggable":1}],13:[function(require,module,exports){
...
/* ========== Data ========== */
    ...
    Object.defineProperty(DataController.prototype,"addTransformToSelected",{writable:true,configurable:true,value:function(transform) {"use strict";
        this.activeRune.selectedPoints.forEach(function(point)  {
            point[0] += transform[0],
            point[1] += transform[1]
        });
...
},{"../global/Events":16,"./TabletModel":26,"lodash":"lodash"}],23:[function(require,module,exports){
...
/* ========== Rune Model ========== */
    ...
    Object.defineProperty(RuneModel.prototype,"selectHandler",{writable:true,configurable:true,value:function(point) {"use strict";
        ...
        if(point.isSelected) {
            ...
            this.selectedPoints.forEach(function(p, i)  {
                if (point == p) {
    ...
    Object.defineProperty(RuneModel.prototype,"deletePoint",{writable:true,configurable:true,value:function(p) {"use strict";
        ...
        this.currentPath.points.forEach(function(point, i)  {
            if (point === p) {
...
},{"./GridModel":23,"./RuneModel":24,"./RunePoint":25}],27:[function(require,module,exports){
'use strict';
...
},{"../global/Events":16,"react":"react"}],28:[function(require,module,exports){
'use strict';
    ...
    render: function() {
        ...
        return (
            React.createElement("div", {
                ...
                React.createElement(Switch, {onToggle: this.setIsCurve.bind(this, this.state.point), symbol: "S"}), 
...
},{"../components/Button.jsx":7,"../components/Switch.jsx":8,"../global/Events":16,"react":"react"}],29:[function(require,module,exports){
'use strict';
...
},{"../global/Keys":17,"react":"react"}],31:[function(require,module,exports){
module.exports = function (exposedData) {
    return [
...
},{"./GridManager.jsx":27,"./InspectPath.jsx":28,"./LayerManager.jsx":29,"./Nudge.jsx":30}]},{},[6]);
