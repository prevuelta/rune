...
var eventHandlers = {
	addPoint : function(data) {
		...
		app.workspace.drawRune(app.tablet.activeRune);
	},
	selectPoint: function(data) {
		if(data[0]) {
			app.tablet.selectPoint(data[1]);
		} else {
			app.tablet.activeRune.selectedPoints = _.without(app.tablet.activeRune.selectedPoints, data[1]);
		}
		// console.log(app.tablet.selectedPoints);
	},
	clearGridPoints : function(e) {
		app.tablet.clearRune();
	...
	deselectAll: function(e) {
		app.tablet.activeRune.selectedPoints = [];
	}
}
