...
LetterView.prototype = {
	...
	draw : function(letterModel, grid) {
		...
		$.each(letterModel.points, function(idx, point) {
			...
			var path = letter.createLetterPoint(point, grid.renderPoint, idx, letterModel.selectedPoints.indexOf(idx) > -1, letterModel.transforms[idx] || null);
	...
	createLetterPoint: function(pointRef, renderFunc, value, selected, transform) {

		var renderedPoint = grid.renderPoint(pointRef);
