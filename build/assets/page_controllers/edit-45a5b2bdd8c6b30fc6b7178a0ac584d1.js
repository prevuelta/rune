...
LetterView.prototype = {
	...
	createLetterPoint: function(point, value, selected, transform) {
		...
		if(transform)
			point.add((function() { var point = new paper.Point(); point.angle = transform[0]; point.length = transform[1]; return point;})());

		var path = new paper.Path.Rectangle(letterPoint.point.x - 5, letterPoint.point.y - 5, 10);
