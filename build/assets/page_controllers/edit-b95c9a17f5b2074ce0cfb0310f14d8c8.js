...
TabletModelController.prototype = {
	...
	deleteSelected : function() {
		...
		var newGridPoints = gridPoints.filter(function(entry, idx) {
			// console.log(gridPoints.indexOf(entry));
			console.log(idx);
			return entry;
			// return tablet.selectedPoints.indexOf(gridPoints.indexOf(entry)) > -1; 
		});
		console.log( newGridPoints );
	}
}
