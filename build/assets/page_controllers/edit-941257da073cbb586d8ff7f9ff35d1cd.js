...
function RuneView(options, paper) {
...
TabletController.prototype.getActiveRune = function() {
...
TabletController.prototype.addRune = function() {
	this.runes.push(new RuneModel());
}

TabletController.prototype.delRune = function() {
...
RuneEditor.prototype.loadTablet = function() {
	...
	if(localStorage["rune"]) {
		...
		this.tablet = new TabletController();
	}
