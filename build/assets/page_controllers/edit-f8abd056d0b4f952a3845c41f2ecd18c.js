...
// 				points[1].y = points[2].y - finalMeasure;
		...
		var firstTransform =
		var secondTransform = [90, -finalMeasure];

		app.workspace.runeView.letter.transforms.push([points[3], [-90, -finalMeasure]]);
		app.workspace.runeView.letter.transforms.push([points[1], [90, finalMeasure]]);
