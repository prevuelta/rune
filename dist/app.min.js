(function (React,reactRedux,ReactDOM) {
  ...
  var initialState$1 = {
    ...
    paths: {
      all: _defineProperty({}, path._id, path),
      current: path._id
    },
    app: initialAppState
  };
  ...
  /*#__PURE__*/
  function (_Component) {
    _inherits(InstructionLine, _Component);

    function InstructionLine(props) {
      var _this;

      _classCallCheck(this, InstructionLine);

      _this = _possibleConstructorReturn(this, _getPrototypeOf(InstructionLine).call(this, props));
  ...
  var InstructionLineConnected = reactRedux.connect(null, actionCreators)(InstructionLine);
  ...
  function (_Component2) {
    ...
    function PathEditor(props) {
      ...
      _this2 = _possibleConstructorReturn(this, _getPrototypeOf(PathEditor).call(this, props));

      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "_onUpdate", function (e) {
        _this2.props.sendInstructions(e.target.value);
      });
    ...
    _createClass(PathEditor, [{
      ...
      value: function render() {
        ...
        return React__default.createElement("ul", {
          ...
          return React__default.createElement(InstructionLineConnected, {
            i: i
          });
        }));
      }
  ...
  function mapStateToProps$4(state) {
    var tablet = Data.getTablet(state);
