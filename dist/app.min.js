(function (React,reactRedux,ReactDOM) {
    ...
    function runeReducer () {
      ...
      return ({
        ...
        ADJUST_RUNE_VALUE: function ADJUST_RUNE_VALUE() {
          ...
          return _objectSpread({}, state, {
            all: _objectSpread({}, state.all, _defineProperty$1({}, rune._id, rune))
          });
        }
    ...
    function pointReducer () {
      ...
      switch (action.type) {
        ...
        case 'ADD_POINT':
          ...
          return _objectSpread$4({}, state, {
            all: [].concat(_toConsumableArray$1(points), [point]),
            selected: [index]
          });
          break;
    ...
    var initialState$1 = {
      runes: {
        all: _defineProperty$7({}, rune._id, rune),
        current: rune._id
      },
      paths: {
        all: [path],
    ...
    function (_Component) {
      ...
      function Arc(props) {
        ...
        _this = _possibleConstructorReturn$1(this, _getPrototypeOf$1(Arc).call(this, props));
        _this.state = {
          radius: 100,
          length: Math.PI / 4,
          startPoint: {
      ...
      _createClass$1(Arc, [{
        ...
        value: function render() {
          ...
          return React__default.createElement(Group, null, React__default.createElement(Point, _extends$2({
            x: 0.5,
            y: 0.5
          }, {
            onMouseDown: function onMouseDown(e) {
    ...
    /*#__PURE__*/
    function (_Component) {
      _inherits$2(Switch, _Component);

      function Switch(props) {
        var _this;

        _classCallCheck$2(this, Switch);

        _this = _possibleConstructorReturn$2(this, _getPrototypeOf$2(Switch).call(this, props));

        _defineProperty$8(_assertThisInitialized$2(_this), "_toggle", function () {
    ...
    function mapStateToProps(state, ownProps) {
      return _objectSpread$6({}, ownProps);
    }
    ...
    var pointStrings = (_pointStrings = {}, _defineProperty$10(_pointStrings, POINT_TYPES.STRAIGHT, function (mX, mY) {
      return "L ".concat(mX, " ").concat(mY);
    }), _defineProperty$10(_pointStrings, POINT_TYPES.ARC, function (mX, mY) {
    ...
    /*#__PURE__*/
    function (_Component) {
      _inherits$3(Overlay, _Component);
      ...
      function Overlay(props) {
        ...
        _this = _possibleConstructorReturn$3(this, _getPrototypeOf$3(Overlay).call(this, props));

        _defineProperty$10(_assertThisInitialized$3(_this), "_onMouseMove", function (e, data) {
        ...
        _defineProperty$10(_assertThisInitialized$3(_this), "_onMouseLeave", function (e) {
          _this.setState({
            markerPosition: null
          });
        });

        _defineProperty$10(_assertThisInitialized$3(_this), "_clickHandler", function (e) {
      ...
      _createClass$3(Overlay, [{
        ...
        value: function render() {
          ...
          return React__default.createElement("svg", {
            ...
            return React__default.createElement(Point, _extends$3({
              index: i,
          ...
          }), selectedPoints.length && React__default.createElement(Helpers, _extends$3({}, props, {
            mode: mode,
    ...
    function mapStateToProps$1(state, ownProps) {
      ...
      return _objectSpread$7({}, ownProps, {
        mode: state.app.mode,
        pathPoints: paths,
    ...
    var POINT_TYPE_STRING = (_POINT_TYPE_STRING = {}, _defineProperty$11(_POINT_TYPE_STRING, POINT_TYPES.STRAIGHT, function (mX, mY) {
      return "L ".concat(mX, " ").concat(mY);
    }), _defineProperty$11(_POINT_TYPE_STRING, POINT_TYPES.ARC, function (mX, mY) {
      return "A 50 50 0 0 1 ".concat(mX, " ").concat(mY);
    }), _POINT_TYPE_STRING);
    ...
    function Rune(props) {
      ...
      return React__default.createElement("div", {
        ...
        className: "rune-size"
      }, "(", rune.x, "x", rune.y, ")")), !proofView && React__default.createElement(BGLayer, _extends$4({}, size, {
        rune: rune
      })), React__default.createElement(RenderLayer, _extends$4({}, size, {
        paths: paths
      })), !proofView && React__default.createElement(Overlay$1, _extends$4({}, size, {
        rune: rune,
        currentPath: currentPath
      })));
    }
    ...
    function mapStateToProps$2(state, ownProps) {
      ...
      return _objectSpread$8({}, ownProps, {
        mode: state.app.mode,
        paths: paths,
    ...
    function (_React$Component) {
      _inherits$4(PanelContainer, _React$Component);

      function PanelContainer(props) {
        var _this;

        _classCallCheck$4(this, PanelContainer);

        _this = _possibleConstructorReturn$4(this, _getPrototypeOf$4(PanelContainer).call(this, props));
        _this.state = {
          collapsed: false
        };
        return _this;
    ...
    var modeActions = (_modeActions = {}, _defineProperty$12(_modeActions, MODE.DRAW, _objectSpread$9({
      a: drawArc,
      p: addPath
    }, nudgeActions)), _defineProperty$12(_modeActions, MODE.DOCUMENT, _objectSpread$9({
      d: setDrawMode,
    ...
    }, keys)), _defineProperty$12(_modeActions, MODE.ARC, {// f: actions.flipArc,
    ...
    var char = '█';
    var charArr = new Array(10).fill(char).join('');
    ...
    /*#__PURE__*/
    function (_Component) {
      _inherits$5(Path, _Component);

      function Path(props) {
        var _this;

        _classCallCheck$5(this, Path);

        _this = _possibleConstructorReturn$5(this, _getPrototypeOf$5(Path).call(this, props));

        _defineProperty$13(_assertThisInitialized$5(_this), "_handleKeyPress", function (e) {
          _this.props.keyPressHandler(e.nativeEvent.keyCode);
        });
    ...
    function (_Component2) {
      _inherits$5(Point, _Component2);

      function Point(props) {
        var _this2;

        _classCallCheck$5(this, Point);

        _this2 = _possibleConstructorReturn$5(this, _getPrototypeOf$5(Point).call(this, props));

        _defineProperty$13(_assertThisInitialized$5(_this2), "_handleKeyPress", function (e) {
          ...
          if (keyCodes[keyCode] === 'delete') {
            if (_this2.state.value === '') {
              _this2.props.deleteHandler(_this2.props.point._id, _this2.ref);
          ...
          _this2.props.keyPressHandler(e.nativeEvent.keyCode);
        });

        _defineProperty$13(_assertThisInitialized$5(_this2), "_handleBlur", function (e) {
          x = format(x);
          y = format(y);
        });

        _defineProperty$13(_assertThisInitialized$5(_this2), "_handleInput", function (e) {
          ...
          var matches = e.target.value.match(exp);
        ...
        _this2.ref = React__default.createRef();

        _this2.props.passRef(_this2.props.point._id, _this2.ref);

        _this2.state = {
          value: "".concat(props.point.x, " ").concat(props.point.y)
        };
        return _this2;
      }

      _createClass$5(Point, [{
        ...
        value: function render() {
          ...
          return React__default.createElement("div", {
            ...
            onFocus: function onFocus() {
              return _this3.props.focusHandler(_this3.props.index);
            },
            value: value
          }));
        }
    ...
    var PointWithRef = React__default.forwardRef(function (props, ref) {
      return React__default.createElement(Point$1, _extends$5({
        innerRef: ref
      }, props));
    });
    var PathConnected = reactRedux.connect(null, actionCreators)(Path$1);
    var PointConnected = reactRedux.connect(mapStateToProps$3, actionCreators)(PointWithRef);

    var PathEditor =
    /*#__PURE__*/
    function (_Component3) {
      _inherits$5(PathEditor, _Component3);

      function PathEditor(props) {
        var _this4;

        _classCallCheck$5(this, PathEditor);

        _this4 = _possibleConstructorReturn$5(this, _getPrototypeOf$5(PathEditor).call(this, props));

        _defineProperty$13(_assertThisInitialized$5(_this4), "_handleFocus", function (selectedIndex) {
          _this4.setState({
            selectedIndex: selectedIndex
          });
        });

        _defineProperty$13(_assertThisInitialized$5(_this4), "_onUpdate", function (e) {// this.props.sendInstructions(e.target.value);
        });

        _defineProperty$13(_assertThisInitialized$5(_this4), "_passRef", function (id, ref) {
          _this4.pointRefs.push(ref);
        });

        _defineProperty$13(_assertThisInitialized$5(_this4), "_handleDelete", function (id, ref) {
          var index = _this4.state.selectedIndex - 1;

          _this4.props.deletePoint(id);

          _this4.pointRefs = _this4.pointRefs.filter(function (r) {
            return r !== ref;
          });

          _this4._focusIndex(index);
        ...
        _defineProperty$13(_assertThisInitialized$5(_this4), "_focusIndex", function (index) {
          if (index > -1) {
            _this4.pointRefs[index].current.focus();
          }
        });

        _defineProperty$13(_assertThisInitialized$5(_this4), "_handleKeyPress", function (keyCode) {
          var key = keyCodes[keyCode];

          if (['up', 'down'].includes(key)) {
            var points = _this4.props.points;
            var selectedIndex = _this4.state.selectedIndex;
            var index;
            ...
            _this4._focusIndex(index); // const selected = this.pointRefs;
            // this.setState(
            //     {
            //         focused: Math.min(
        ...
        _this4.pointRefs = props.points.map(function (p) {
          return React__default.createRef();
        });

        for (var i = 0; i < 3; i++) {
          _this4.props.addPoint({
            x: 0,
            y: 0,
        ...
        value: function render() {
          ...
          return React__default.createElement("div", {
            ...
            return React__default.createElement(PointConnected, {
              key: point._id,
              passRef: _this5._passRef,
              point: point,
              index: j,
              keyPressHandler: _this5._handleKeyPress,
              focusHandler: _this5._handleFocus,
              deleteHandler: _this5._handleDelete
            });
          }));
        }
      }]);
