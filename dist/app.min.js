(function (React,reactRedux,ReactDOM) {
  ...
  var updatePath = function updatePath(id, value) {
    return {
      type: 'UPDATE_PATH',
      id: id,
      value: value
  ...
  function pathReducer () {
    ...
    switch (action.type) {
      ...
      case 'ADD_PATH':
        ...
        return {
          paths: [].concat(_toConsumableArray(state.paths), ['']) // ...state,
          // current: path._id,
          // selected: [],
          // all: [...state.all, path],
      ...
      case 'UPDATE_PATH':
        return {
          paths: paths.map(function (p, i) {
            return i === action.i ? action.value : p;
          })
        };
        break;
  ...
  var rune = RuneFactory(); // const path = PathModel({ rune: rune._id });
  ...
  var Data = {
    ...
    getCurrent: function getCurrent(key) {
      var state = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : store.getState();
      var selected = state.app.selected[key].selected;
      return state[key][selected]; // return state[model].all[state[model].current];
    }
  };
  ...
  function (_Component) {
    ...
    _createClass(Arc, [{
      ...
      value: function render() {
        ...
        return React__default.createElement(Group, null, React__default.createElement(Point$1, _extends({
          x: 0.5,
          y: 0.5
        }, {
          onMouseDown: function onMouseDown(e) {
    ...
    _createClass(Overlay, [{
      ...
      value: function render() {
        ...
        return React__default.createElement("svg", {
          ...
          return React__default.createElement(Point$1, _extends({
            index: i,
  ...
  var char = '█';
  var charArr = new Array(10).fill(char).join(''); // function format(number) {
  ...
  function (_Component) {
    ...
    function Path(props) {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_handleInput", function (e) {
        ...
        // console.log(result);
        // const exp = /^(\d*(?:[.]\d*)?) (\d*(?:[.]\d*)?)$/;
        var value = e.target.value; // const matches = e.target.value.match(exp);
        // if (matches) {
        // let [, x, y] = matches;
        ...
        _this.setState({
          ...
          _this.props.updatePath(_this.props.index, value);
        });
      });
      ...
      value: function render() {
        ...
        return React__default.createElement("div", {
          ...
          onFocus: function onFocus() {
            return _this2.props.focusHandler(_this2.props.index);
          },
          value: value
        }));
      }
  ...
  var PathConnected = reactRedux.connect(null, actionCreators)(Path);
  var PointConnected = reactRedux.connect(mapStateToProps$3, actionCreators)(PointWithRef);

  var PathEditor =
  /*#__PURE__*/
  function (_Component2) {
    _inherits(PathEditor, _Component2);
    ...
    function PathEditor(props) {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this3)), "_handleFocus", function (selectedIndex) {
        _this3.setState({
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this3)), "_passRef", function (id, ref) {
        _this3.pointRefs.push(ref);
      });

      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this3)), "_handleDelete", function (id, ref) {
        var index = _this3.state.selectedIndex - 1;

        _this3.props.deletePoint(id);

        _this3.pointRefs = _this3.pointRefs.filter(function (r) {
          return r !== ref;
        });

        _this3._focusIndex(index);
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this3)), "_focusIndex", function (index) {
        if (index > -1) {
          _this3.pointRefs[index].current.focus();
        }
      });

      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this3)), "_handleKeyPress", function (keyCode) {
        var key = keyCodes[keyCode];

        if (['up', 'down'].includes(key)) {
          var paths = _this3.props.paths;
          ...
          _this3._focusIndex(index); // const selected = this.pointRefs;
          // this.setState(
          //     {
          //         focused: Math.min(
      ...
      _this3.pathRefs = props.paths.map(function (p) {
        return React__default.createRef();
      });

      for (var i = 0; i < 3; i++) {
        _this3.props.addPoint({
          x: 0,
          y: 0,
    ...
    _createClass(PathEditor, [{
      ...
      value: function render() {
        ...
        return React__default.createElement("div", {
          className: "paths"
        }, paths.map(function (path, j) {
          return React__default.createElement(PathConnected, {
            key: point._id,
            passRef: _this4._passRef,
            path: path,
            index: j,
            keyPressHandler: _this4._handleKeyPress,
            focusHandler: _this4._handleFocus,
            deleteHandler: _this4._handleDelete
          });
        }));
      }
    }]);
  ...
  var PathEditor$1 = reactRedux.connect(mapStateToProps$3, actionCreators)(PathEditor);
  ...
  var Workspace$1 = reactRedux.connect(mapStateToProps$4, actionCreators)(Workspace);

  var render = function render() {
    ReactDOM.render(React__default.createElement(reactRedux.Provider, {
      store: store
    }, React__default.createElement(Workspace$1, null)), document.getElementById('app'));
  };
