(function (React,reactRedux,ReactDOM) {
  ...
  var store = createStore(rootReducer, initialState$1, applyMiddleware(pointResize));
  ...
  /*#__PURE__*/
  function (_Component) {
    _inherits(PathEditor, _Component);
    ...
    function PathEditor(props) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(PathEditor).call(this, props));

      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onUpdate", function (e) {
  ...
  var App = reactRedux.connect(mapStateToProps$3, actionCreators)(Workspace);
