(function (React,reactRedux,ReactDOM) {
  ...
  function (_Component2) {
    ...
    function Point(props) {
      ...
      _this2 = _possibleConstructorReturn(this, _getPrototypeOf(Point).call(this, props));
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "_handleBlur", function (e) {
        x = format(x);
        y = format(y);
      });
  ...
  function (_Component3) {
    ...
    function PathEditor(props) {
      ...
      _this4 = _possibleConstructorReturn(this, _getPrototypeOf(PathEditor).call(this, props));

      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this4)), "_handleFocus", function (selectedIndex) {
        _this4.setState({
          selectedIndex: selectedIndex
        });
      });

      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this4)), "_onUpdate", function (e) {// this.props.sendInstructions(e.target.value);
      });

      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this4)), "_passRef", function (id, ref) {
        _this4.pointRefs.push(ref);
      });

      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this4)), "_handleKeyPress", function (keyCode) {
        if (keyCode === 40 || keyCode === 38) {
          ...
          console.log(_this4.pointRefs);

          _this4.pointRefs[index].current.focus(); // const selected = this.pointRefs;
          // this.setState(
          //     {
          //         focused: Math.min(
